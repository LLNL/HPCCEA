...
RELEASE_VERSION="4.0.24.10-71114"
BUILD_DATE="(built Wed Nov 9 10:22:50 PST 2016)"
...
def get_power_status(conn, options):
	...
	if options['--action'] == 'monitor':
		if pm.is_running():
			...
			return "on"
		logging.error("powerman is NOT running, unable to get status\n")
		return "error"
	else:
